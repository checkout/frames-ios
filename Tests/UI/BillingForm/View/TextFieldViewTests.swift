...
class TextFieldViewTests: XCTestCase {
    ...
    func testStyle() {
        ...
        XCTAssertFalse(style?.isSupportingNumericKeyboard == true)
    ...
    func testSecuredTextFieldViewIsNotSubView() {
        ...
        XCTAssertFalse(isTextFieldExposed == true)
    }
    ...
    func testSecuredTextFieldWithMirrorObject() throws {
