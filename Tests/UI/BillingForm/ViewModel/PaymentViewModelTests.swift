...
class PaymentViewModelTests: XCTestCase {
    ...
    func testInit() {
        ...
        let testBillingFormData = BillingForm(
            name: "John Doe",
            address:
                Address(
                    addressLine1: "home",
                    addressLine2: "sleeping",
                    city: "rough night",
                    state: "tired",
                    zip: "Zzzz",
                    country: nil),
        ...
        let viewModel = DefaultPaymentViewModel(
    ...
    func testUpdateExpiryDateView() {
        let checkoutAPIService = Frames.CheckoutAPIService(publicKey: "", environment: Environment.sandbox)
        viewModel = DefaultPaymentViewModel(
            checkoutAPIService: checkoutAPIService,
            cardValidator: CardValidator(environment: .sandbox),
    ...
    func testUpdateEditBillingSummaryView() {
        ...
        let address = Address(
            addressLine1: "Test line1 Custom 1",
            addressLine2: nil,
            city: "London Custom 1",
            state: "London Custom 1",
            zip: "N12345",
            country:
                Country(iso3166Alpha2: "GB"))
        let phone = Phone(
            number: "77 1234 1234",
        ...
        let billingFormData = BillingForm(
            ...
            address: address,
            phone: phone)
        let checkoutAPIService = Frames.CheckoutAPIService(
            publicKey: "",
    ...
    func testPreventDuplicateCardholderInput() {
        ...
        var billingName = viewModel.billingFormStyle?.cells.first {
        ...
        XCTAssertNotNil(viewModel.paymentFormStyle?.cardholderInput)
        billingName = viewModel.billingFormStyle?.cells.first {
            if case BillingFormCell.fullName = $0 {
                return true
            }
            return false
    ...
    private func makeViewModel(
        apiService: Frames.CheckoutAPIProtocol = StubCheckoutAPIService(),
