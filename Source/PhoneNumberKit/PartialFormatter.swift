...
public final class PartialFormatter {
    ...
    public convenience init(phoneNumberKit: CKOPhoneNumberKit = CKOPhoneNumberKit(), defaultRegion: String = CKOPhoneNumberKit.defaultRegionCode(), withPrefix: Bool = true, maxDigits: Int? = nil) {
    ...
    init(phoneNumberKit: CKOPhoneNumberKit, regexManager: RegexManager, metadataManager: MetadataManager, parser: PhoneNumberParser, defaultRegion: String, withPrefix: Bool = true, maxDigits: Int? = nil) {
