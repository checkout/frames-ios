...
public class CountryCodePickerViewController: UITableViewController {
    ...
    lazy var countries: [[Country]] = {
        ...
        if hasCurrent, let current = Country(for: CKOPhoneNumberKit.defaultRegionCode(), with: phoneNumberKit) {
...
internal extension CountryCodePickerViewController {
    ...
    struct Country {
        ...
        init?(for countryCode: String, with phoneNumberKit: CKOPhoneNumberKit) {
