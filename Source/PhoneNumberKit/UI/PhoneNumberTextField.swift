...
open class PhoneNumberTextField: UITextField, UITextFieldDelegate {
    ...
    private lazy var _defaultRegion: String = CKOPhoneNumberKit.defaultRegionCode()
    ...
    /**
     ...
     - returns: UITextfield
     */
    public convenience init(withPhoneNumberKit phoneNumberKit: CKOPhoneNumberKit) {
    ...
    /**
     ...
     - returns: UITextfield
     */
    public init(frame: CGRect, phoneNumberKit: CKOPhoneNumberKit) {
