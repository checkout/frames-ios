...
final class PaymentViewController: UIViewController {
    ...
    private lazy var stackView: UIStackView = {
        ...
        view.axis = .vertical
        view.spacing = Constants.Padding.large.rawValue
        return view
    }()
    ...
    private func setupNavigationBar() {
        ...
        navigationItem.leftBarButtonItem = UIBarButtonItem(
            image: Constants.Bundle.Images.leftArrow.image,
            style: .plain,
            target: self,
    ...
    @objc private func keyboardWillShow(notification: Notification) {
        ...
        contentInset.bottom = keyboardFrame.size.height + Constants.Padding.large.rawValue
...
extension PaymentViewController {
    ...
    private func addArrangedSubviewForStackView() {
        var paymentViews: [UIView] = [ headerView ]
        ...
        stackView.layoutMargins = UIEdgeInsets(
            top: 0,
            left: Constants.Padding.large.rawValue,
            bottom: Constants.Padding.large.rawValue,
            right: Constants.Padding.large.rawValue)
