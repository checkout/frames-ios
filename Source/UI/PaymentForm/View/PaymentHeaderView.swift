...
public final class PaymentHeaderView: UIView {
    ...
    private(set) lazy var iconsStackView: UIStackView = {
        ...
        view.spacing = Constants.Padding.xSmall.rawValue
        return view
    }()
...
extension PaymentHeaderView {
    ...
    private func setupIconStackView() {
        ...
        NSLayoutConstraint.activate([
            ...
            iconsStackView.bottomAnchor.constraint(equalTo: iconsViewContainer.bottomAnchor, constant: -Constants.Padding.large.rawValue)
        ])
    }
}
