...
public enum PaymentFormFactory {
    ...
    public static func buildViewController(configuration: PaymentFormConfiguration, style: PaymentStyle, completionHandler: @escaping (Result<TokenDetails, TokenisationError.TokenRequest>) -> Void) -> UIViewController {
        ...
        let checkoutAPIService = CheckoutAPIService(
            publicKey: configuration.serviceAPIKey,
