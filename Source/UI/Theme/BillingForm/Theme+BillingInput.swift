...
public extension Theme {
    ...
    func buildBillingInput(
        ...
        return ThemeBillingInput(
            ...
            isMandatory: isMandatory,
            title: buildTitle(text: title),
            mandatory: showMandatory ? buildIsRequiredInput(text: isRequiredText) : nil,
            hint: showSubtitle ? buildSubtitle(text: subtitle, image: subtitleImage) : nil,
            error: showError ? buildError(text: errorText, image: errorImage) : nil)
    }
}
