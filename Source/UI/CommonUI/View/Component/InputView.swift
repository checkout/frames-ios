...
class InputView: UIView {
    ...
    private func updateTextFieldContainer(style: CellTextFieldStyle) {
        ...
        style.textfield.borderStyle.errorBorderColor.cgColor :
        style.textfield.borderStyle.normalBorderColor.cgColor
...
extension InputView: TextFieldViewDelegate {
    func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool {
        ...
        textFieldContainerBorder.layer.borderColor = style?.textfield.borderStyle.focusBorderColor.cgColor
