...
public protocol CardNumberValidating {
    ...
    /// - Returns: ValidationScheme if successful. This contain the scheme matched and a bool to describe if input is complete card number or partial.   ValidationError if a scheme could not be matched
