...
struct SummaryButtonStyleCustom1: ElementButtonStyle {
  ...
  var isHidden = false
  var isEnabled = true
  var shouldImageFlippedForRightToLeftLayoutDirection = true
...
struct CancelButtonFormStyleCustom1: ElementButtonStyle {
  ...
  var isHidden = false
  var isEnabled = true
  var shouldImageFlippedForRightToLeftLayoutDirection = false
...
struct TextFieldCustom1: ElementTextFieldStyle {
  ...
  var isPlaceHolderHidden = false
  var font = UIFont(name: "Helvetica Neue", size: 14)!
  var textColor = UIColor(red: 40 / 255.0, green: 46 / 255.0, blue: 54 / 255.0, alpha: 1.0)
  ...
  var isSecured = false
  var isSupportingNumericKeyboard = false
}
...
struct ErrorInputLabelStyleCustom1: ElementErrorViewStyle {
  ...
  var shouldImageFlippedForRightToLeftLayoutDirection: Bool = false
  var backgroundColor = UIColor(red: 240 / 255.0, green: 245 / 255.0, blue: 249 / 255.0, alpha: 1.0)
