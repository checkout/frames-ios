...
class HomeViewController: UIViewController {
  ...
  private lazy var checkoutAPIService = Frames.CheckoutAPIService(publicKey: Factory.apiKey, environment: Factory.environment, baseURLPrefix: Factory.baseURLPrefix)
